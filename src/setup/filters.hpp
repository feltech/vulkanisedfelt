 ...
 */
constexpr auto make_filter_surface_formats(std::span<VkFormat const> desired_formats)
{
	return [desired_formats](std::span<VkSurfaceFormatKHR const> available_surface_formats)
